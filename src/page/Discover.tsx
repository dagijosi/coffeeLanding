    ...
    <div className="min-h-screen py-8 md:py-12">
      <div className="flex flex-col md:flex-row items-center justify-between relative h-full md:h-[90%] gap-8">
        <div className="px-4 md:px-12 lg:px-24 space-y-4 md:space-y-8 max-w-full md:max-w-[50%]">
          ...
          <Button className="bg-[#F9C06A] hover:bg-[#feb850] text-base font-medium px-6 md:px-10 py-3 md:py-3.5 rounded-3xl mt-6 md:mt-10 text-black transition-all duration-300 hover:shadow-lg w-full md:w-auto">
            Learn More
          </Button>
        </div>
        <img
      ...
      <div className="relative">
        <Different />
        <img
          src="/image/coffee_blast2.png"
          alt="blast"
          className="w-[15rem] md:w-[24rem] h-auto md:h-[10rem] object-cover absolute -top-16 right-0 hidden md:block"
        />
      </div>
    </div>
  );
